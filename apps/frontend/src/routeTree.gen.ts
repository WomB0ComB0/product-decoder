...
import { ServerRoute as ApiV1AuthSplatServerRouteImport } from './routes/api/v1/auth/$'
...
const ApiV1AuthSplatServerRoute = ApiV1AuthSplatServerRouteImport.update({
  id: '/api/v1/auth/$',
  path: '/api/v1/auth/$',
  getParentRoute: () => rootServerRouteImport,
} as any)
...
export interface FileServerRoutesByFullPath {
  ...
  '/api/v1/auth/$': typeof ApiV1AuthSplatServerRoute
}
...
export interface FileServerRouteTypes {
  ...
  fullPaths: '/api/health' | '/api/v1/auth/$'
  fileServerRoutesByTo: FileServerRoutesByTo
  to: '/api/health' | '/api/v1/auth/$'
  id: '__root__' | '/api/health/' | '/api/v1/auth/$'
  fileServerRoutesById: FileServerRoutesById
}
export interface RootServerRouteChildren {
  ApiHealthIndexServerRoute: typeof ApiHealthIndexServerRoute
  ApiV1AuthSplatServerRoute: typeof ApiV1AuthSplatServerRoute
}
...
declare module '@tanstack/react-start/server' {
  interface ServerFileRoutesByPath {
    ...
    '/api/v1/auth/$': {
      ...
      preLoaderRoute: typeof ApiV1AuthSplatServerRouteImport
      parentRoute: typeof rootServerRouteImport
    }
  }
}
...
const rootServerRouteChildren: RootServerRouteChildren = {
  ...
  ApiV1AuthSplatServerRoute: ApiV1AuthSplatServerRoute,
}
